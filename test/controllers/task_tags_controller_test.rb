...
class TaskTagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_tag" do
    assert_difference("TaskTag.count") do
      post task_tags_url, params: { task_tag: { tag_name: @task_tag.tag_name, task_id: @task_tag.task_id } }
    end
  ...
  test "should update task_tag" do
    patch task_tag_url(@task_tag), params: { task_tag: { tag_name: @task_tag.tag_name, task_id: @task_tag.task_id } }
