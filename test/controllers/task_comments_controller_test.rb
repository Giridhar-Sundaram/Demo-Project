...
class TaskCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_comment" do
    assert_difference("TaskComment.count") do
      post task_comments_url, params: { task_comment: { author_id: @task_comment.author_id, date: @task_comment.date, task_id: @task_comment.task_id, text: @task_comment.text } }
    end
  ...
  test "should update task_comment" do
    patch task_comment_url(@task_comment), params: { task_comment: { author_id: @task_comment.author_id, date: @task_comment.date, task_id: @task_comment.task_id, text: @task_comment.text } }
